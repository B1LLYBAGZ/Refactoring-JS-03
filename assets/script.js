...
// creating a function to calaculate the AVARAGAE salary in the array called employees.
// what is employeesAvrage tho?
const displayAverageSalary = function (employeesAverage) {
  let sum = 0;

  for (let i = 0; i < employeesAverage.length; i++) {
    sum += parseFloat(employeesAverage[i].salary);
  }
...
const getRandomEmployee = function (employees) {
  ...
  // Call the function to get a random
  console.log(`congradulations ${randomElement.firstName} you won!`);
};
/*
  ====================
  STARTER CODE
